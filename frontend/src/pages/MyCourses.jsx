                        ...
                        <div className="card" style={{ borderRadius: 16, border: '1px solid #e5e7eb' }}>
                          <div className="card-body">
                            <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                              ...
                              <Link to={`/course/${course.courseId}`} className="btn btn-primary" style={{ borderRadius: 8, minWidth: '140px' }}>Continue Learning</Link>
                            </div>
                            
                            <div className="mt-4">
                              <div className="d-flex justify-content-between align-items-center mb-1">
                                <div style={{ fontSize: '0.9rem', color: '#6b7280' }}>Progress</div>
                                <div style={{ fontSize: '0.9rem', fontWeight: 600 }}>42%</div>
                              </div>
                              <div className="progress" style={{ height: 8, borderRadius: 999, background: '#e9edf2' }}>
                                <div className="progress-bar" role="progressbar" style={{ width: '42%', backgroundColor: '#4361ee' }}></div>
                              </div>
                            </div>
                            
                            <div className="mt-3">
                              <div className="d-flex flex-wrap gap-2">
                                <span className="badge bg-light text-dark">4 modules</span>
                                <span className="badge bg-light text-dark">12 lessons</span>
                                <span className="badge bg-light text-dark">3 quizzes</span>
                              </div>
                            </div>
                          </div>
                        </div>
